      ...
      <div className="p-6">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h4 className="text-lg font-semibold text-foreground">Upcoming Bookings</h4>
          ...
          {bookings?.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-xs text-muted-foreground mt-1">Bookings will appear here when guests make reservations</p>
            </div>
          )}
        </div>
      </div>
