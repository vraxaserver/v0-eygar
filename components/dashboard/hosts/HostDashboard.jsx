...
export default function HostDashboard() {
  ...
  const stats = [
    { title: 'Total Earnings', value: '$12,450', change: '+12%', icon: <DollarSign className="w-6 h-6" /> },
    { title: 'Active Listings', value: '8', change: '+2', icon: <Home className="w-6 h-6" /> },
    { title: 'Total Bookings', value: '156', change: '+8%', icon: <Calendar className="w-6 h-6" /> },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-6 h-auto">
            ...
            <TabsTrigger value="guests" className="text-xs md:text-sm">Guests</TabsTrigger>
            <TabsTrigger value="experiences" className="text-xs md:text-sm">Experiences</TabsTrigger>
                  ...
                  {upcomingBookings.slice(0, 3).map((booking) => (
                    <div key={booking.id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-gray-600">{booking.property}</div>
                        <div className="text-xs text-gray-500">
                          {new Date(booking.checkIn).toLocaleDateString()} - {new Date(booking.checkOut).toLocaleDateString()}
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="font-semibold text-sm">{booking.total}</div>
                  ...
                  <CardContent className="p-0">
                    <div className="relative">
                      ...
                      <div className="absolute top-3 right-3 flex space-x-1">
                        ...
                        <Button variant="secondary" size="sm" className="w-8 h-8 p-0 text-red-600">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-sm font-semibold">${property.price}/night</div>
                      </div>
                      <div className="grid grid-cols-2 gap-4 text-xs text-gray-600">
                        ...
                        <div>
                          <div className="font-medium">{property.earnings}</div>
          ...
          <TabsContent value="properties" className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
              <div>
                ...
                <p className="text-gray-600">Manage your listings, pricing, and availability</p>
              </div>
              <Button className="bg-purple-600 hover:bg-purple-700">
                <Plus className="w-4 h-4 mr-2" />
                Add New Property
                    ...
                    <div className="p-4">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                        ...
                        <div>
                          ...
                          <div className="font-semibold">${property.price}/night</div>
                        </div>
                        <div>
                          <div className="text-gray-600">Bookings</div>
                          <div className="font-medium">{property.bookings} this month</div>
                        </div>
                        <div>
                          <div className="text-gray-600">Earnings</div>
                          <div className="font-medium text-green-600">{property.earnings}</div>
                        </div>
                      </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-4 md:space-y-0">
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <Badge className={getStatusColor(booking.status)}>
                            {getStatusIcon(booking.status)}
                            <span className="ml-1">checked-in</span>
                          </Badge>
                          <div className="flex space-x-2">
                            <Button size="sm" variant="outline">
                              <MessageSquare className="w-4 h-4 mr-1" />
          ...
          <TabsContent value="guests" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[...upcomingBookings, ...ongoingBookings].map((booking) => (
                ...
                <Card key={experience.id} className="group hover:shadow-lg transition-all">
                  <CardContent className="p-0">
                    <div className="relative">
                      ...
                      />
                      <Badge 
                        className={`absolute top-3 left-3 ${getStatusColor(experience.status)}`}
                      >
                        {experience.status}
                      </Badge>
                      <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity flex space-x-1">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-sm font-semibold">${experience.price}/person</div>
                      </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      <BarChart3 className="w-12 h-12 mx-auto mb-4 text-gray-400" />
                      <p className="text-gray-600">Booking trends chart will be displayed here</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
