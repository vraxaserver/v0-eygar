    ...
    <div className="w-full mb-16 mt-10">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4 px-2 sm:px-0">
        <div className="w-full sm:w-auto">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">{t("home.unique_experience_section_title")}</h2>
          <p className="text-gray-600 text-sm sm:text-base">{t("home.unique_experience_section_desc")}</p>
        </div>
          ...
          >
            <div className="relative">
              ...
              <div className="relative h-40 sm:h-44 md:h-48 lg:h-52 xl:h-56 w-full overflow-hidden">
                ...
                {/* Free Badge */}
                <Badge className="absolute top-3 left-3 bg-green-500 text-white text-xs px-2 py-1">FREE</Badge>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <div className="w-6 h-6 bg-[#814193] rounded-full flex items-center justify-center">
                      <span className="text-white text-xs font-bold">{experience.host.split(" ")[0]?.[0] || "H"}</span>
                    </div>
